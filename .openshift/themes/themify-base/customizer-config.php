...
function themify_base_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'body_background' => array(
			...
			'control' => array(
				...
				'label'   => __( 'Body', 'themify' ), // Visible name of the control.
		...
		// Footer Widget List Styling #footer .widget li
...
add_filter( 'themify_base_customizer_settings', 'themify_base_theme_customizer_definition' );